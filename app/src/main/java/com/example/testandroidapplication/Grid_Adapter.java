...
public class GridAdapter extends ArrayAdapter {
    ...
    private List<Gig> allEvents;
    public GridAdapter(Context context, List<Date> monthlyDates, Calendar currentDate, List<Gig> allEvents) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //Visual for current Month and Year
