...
import com.example.testandroidapplication.Notifications.Client;
...
public class ActualMessaging extends AppCompatActivity {
    ...
    private void sendMessage(String sender, final String receiver, String message) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(notify) {
                    sendNotifcation(receiver, user.getUsername(), msg);
                }
                notify = false;
            }
    ...
    private void sendNotifcation(String receiver, final String username, final String message){
                        ...
                        public void onResponse(Call<MyResponse> call, Response<MyResponse> response) {
                            if(response.code()==200){
                                if(response.body().success != 1){
                                    Toast.makeText(ActualMessaging.this, "Failed!", Toast.LENGTH_SHORT).show();
                                }
                            }
                        }
